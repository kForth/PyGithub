...
class RepositoryLicense(github.GithubObject.CompletableGithubObject):
    """
    This class represents Licenses. The reference can be found here https://docs.github.com/en/rest/reference/repository-licenses
    """
